          ...
          <div className="grid md:grid-cols-2 gap-10 sm:gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed mb-4 text-sm sm:text-base">
                ...
                experience of joy, connection, and celebration. Founded in 2010,
                our restaurant brings together the rich culinary heritage of
                India with the warmth of royal hospitality.
              </p>
