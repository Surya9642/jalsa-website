...
const MenuDin = () => {
  ...
  const categories = useMemo(() => {
    ...
    set.add("All");
    dineInMenu.forEach((i) => set.add(i.category));
  ...
  const filteredItems =
    selectedCategory === "All"
      ? dineInMenu
      : dineInMenu.filter((i) => i.category === selectedCategory);
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col overflow-hidden">
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center">
        ...
        <h1 className="relative z-10 text-6xl font-heading font-bold text-primary-foreground">
          Dine-In Menu
        </h1>
      </section>
      ...
      <section className="py-10 container mx-auto px-4">
        ...
        {/* SPICE LEVEL */}
        <div className="text-center text-primary text-[15px] mb-8 px-3">
